...
public class ReklamResimDetayActivity extends AppCompatActivity {
    ProgressDialogManager progressDialogManager = new ProgressDialogManager(ReklamResimDetayActivity.this, "");
    ImageView ivResim;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reklam_resim_detay);
        ...
        btnResimSil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (resimId > 0) {
                    ...
                    Call<Void> call = api.deleteResim(resimId);
    ...
    private void getImage() {
        progressDialogManager.createProgressBar();
        Call<ReklamResim> call = api.getReklamResim(resimId);
        call.enqueue(new Callback<ReklamResim>() {
            @Override
            public void onResponse(Call<ReklamResim> call, Response<ReklamResim> response) {
                if (response.isSuccessful()) {
            ...
            @Override
            public void onFailure(Call<ReklamResim> call, Throwable t) {
                Toasty.error(ReklamResimDetayActivity.this,"Hata :"+t.getMessage().toString(),Toasty.LENGTH_SHORT,true).show();
                progressDialogManager.createProgressBar();
            }
        });
    ...
    private void createLayoutElements() {
        toolbar = findViewById(R.id.toolbarReklamResimDetay);
