...
public class Reklam implements Serializable, Parcelable
{
    ...
    public final static Creator<Reklam> CREATOR = new Creator<Reklam>() {


        @SuppressWarnings({
                "unchecked"
        })
        public Reklam createFromParcel(android.os.Parcel in) {
            return new Reklam(in);
        }

        public Reklam[] newArray(int size) {
            return (new Reklam[size]);
        }

    }
            ;
    private final static long serialVersionUID = -4307732118639008377L;

    protected Reklam(android.os.Parcel in) {
     ...
     * @param ustBolum
     */
    public Reklam(String islemTarihi, String kayitEden, int id, int aracId, String baslangicTarihi, String bitisTarihi, String ybsNo, boolean onBolum, boolean arkaBolum, boolean sagBolum, boolean solBolum, boolean ustBolum, boolean aktif, String aciklama) {
        super();
