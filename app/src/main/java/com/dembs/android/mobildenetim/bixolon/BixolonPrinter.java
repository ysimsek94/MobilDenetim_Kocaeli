package com.dembs.android.mobildenetim.bixolon;
...
//
    ...
    private boolean setTargetDevice(int portType, String logicalName, int deviceCategory, String address) {
        try {
            ...
            bxlConfigLoader.addEntry(logicalName, deviceCategory, "SPP-R410", portType, address);
    ...
    public boolean printText(String data, int alignment, int attribute, int textSize) {
        ...
        try {
            if (!posPrinter.getDeviceEnabled()) {
                Toast.makeText(this.context,"Bağlanamadı Print text",Toast.LENGTH_LONG).show();
                return false;
